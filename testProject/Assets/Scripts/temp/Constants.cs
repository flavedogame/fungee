...
namespace Constants {
	...
	internal class AnimationTuples {
		...
		internal static AnimationTuple deadAnimation = new AnimationTuple("isDead",true);
		internal static AnimationTuple stopDeadAnimation = new AnimationTuple("isDead",false);
		}
}
